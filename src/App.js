...
function App() {
  ...
  const handleDeleteCompletedeTodo=(index)=>{
        ...
        <div className="todo-input">
          ...
          <div className="todo-input-item">
            ...
            <input
              ...
              placeholder="some of the Description?"
            />
          </div>
          <div className="todo-input-item">
            <button
          ...
          {isCompleteScreen === false &&
            allTodos.map((item, index) => {
                if(currentEdit===index){
                    ...
                    <div className="edit_wrapper" key={index}>
                      ...
                      />
                      <textarea
                        placeholder="Updated Title" rows={4}
            ...
            {isCompleteScreen===true && completedTodos.map ((item,index)=>{
                return(
                   ...
                   <div>
                    <AiOutlineDelete className="icon" onClick={()=>handleDeleteCompletedeTodo(index)}
                    title="Delete?"
                    />
                    </div>
